...
The Tennessee STAR experiment (Mosteller 1995) randomly assigned more than 6,000 students to small classes (13–17 students), regular classes (22–25), or regular classes with a teacher's aide, from kindergarten through third grade. Imagine you work for the Texas Department of Education. You want to understand the effect of small classes on student performance in Dallas. In Texas, there is data available like the data in the STAR project. This week you will use the STAR data to answer the Department's question: What is the average causal effect of assigning a Dallas student to a small class on their fourth-grade math score?
